...
**Direct download of the text file in PARSEME:MWE format (~14.3MB): [PARSEME:MWE Download](ronec/conllup/ronec.conllup)**

**Direct download of the text file in IOB format (~14.5MB): [IOB Download](ronec/conllup/ronec_iob.conllup)**
